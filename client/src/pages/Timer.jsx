                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="48%" valign="top" style="background-color:#18181b;border:1px solid #27272a;border-radius:12px;padding:24px 16px;text-align:center;">
                                        ...
                                        <p style="margin:0 0 10px 0;color:#e4e4e7;font-size:15px;font-weight:500;">1 Copy &nbsp;<span style="color:#25D366;font-weight:700;">₹44</span></p>
                                        <p style="margin:0 0 10px 0;color:#e4e4e7;font-size:15px;font-weight:500;">2 Copies &nbsp;<span style="color:#25D366;font-weight:700;">₹54</span></p>
                                        <p style="margin:0;color:#e4e4e7;font-size:15px;font-weight:500;">3+ Copies &nbsp;<span style="color:#25D366;font-weight:700;">₹84</span></p>
                                    </td>
                                    <td width="4%"></td>
                                    <td width="48%" valign="top" style="background-color:#1c1314;border:1px solid #3f1515;border-radius:12px;padding:24px 16px;text-align:center;">
                                        ...
                                        <p style="margin:0 0 10px 0;color:#e4e4e7;font-size:15px;font-weight:500;">1 Copy &nbsp;<span style="color:#ff3b3b;font-weight:700;">₹54</span></p>
                                        <p style="margin:0 0 10px 0;color:#e4e4e7;font-size:15px;font-weight:500;">2 Copies &nbsp;<span style="color:#ff3b3b;font-weight:700;">₹64</span></p>
                                        <p style="margin:0;color:#e4e4e7;font-size:15px;font-weight:500;">3+ Copies &nbsp;<span style="color:#ff3b3b;font-weight:700;">₹94</span></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
